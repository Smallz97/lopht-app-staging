...
import MobileHero from "@/app/(public)/(landing-pages)/ui/privacy-policy-page/images/mobile-hero.png"
import DesktopHero from "@/app/(public)/(landing-pages)/ui/privacy-policy-page/images/tablet-hero.png"
