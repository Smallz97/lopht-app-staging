...
import { Users, Heart, TrendingUp, Smile, Flag, Zap } from "@/app/lib/icons";
...
const features = [
  {
    ...
    imageSm: FirstFeature,
    imageMd: FirstFeatureLarge,
  },
  {
    alt: "",
    ...
    imageSm: SecondFeature,
    imageMd: SecondFeatureLarge,
  },
  {
    alt: "",
    ...
    imageSm: ThirdFeature,
    imageMd: ThirdFeatureLarge,
  },
];
...
export { features, teamMembers, companyValues, pageHeadings };
