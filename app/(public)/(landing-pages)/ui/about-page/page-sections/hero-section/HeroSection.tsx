...
import mobileHero from "@/app/(public)/(landing-pages)/ui/about-page/images/hero-images/mobile-hero.png";
import tabletHero from "@/app/(public)/(landing-pages)/ui/about-page/images/hero-images/tablet-hero.png";
