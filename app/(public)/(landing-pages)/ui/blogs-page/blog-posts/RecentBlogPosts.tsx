...
import FirstDesktop from '@/app/(public)/(landing-pages)/ui/blogs-page/blogposts-images/recent-blog-posts/first-dekstop.png'
import { ArrowLink } from "@/app/lib/icons";
import { Blogpost } from "@/app/lib/definitions";
import { RecentBlogPostsList } from "@/app/lib/blogposts-placeholder";
